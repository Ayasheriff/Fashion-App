      ...
      <ScrollView horizontal={false}>
        <View style={{flexDirection: 'row'}}>
          <Card
            ...
            <Card.Cover
              ...
              source={require('../../assets/images/makeup1.jpg')}
            />
          ...
          <Card
            ...
            <Card.Cover
              style={{width: '85%', alignSelf: 'center', marginTop: 10}}
              source={require('../../assets/images/makeup2.jpg')}
            />
        ...
        <View style={{flexDirection: 'row'}}>
          <Card
            ...
            <Card.Cover
              style={{width: '85%', alignSelf: 'center', marginTop: 10}}
              source={require('../../assets/images/makeup3.png')}
            />
        ...
        <View style={{flexDirection: 'row'}}>
          <Card
            ...
            <Card.Cover
              style={{width: '85%', alignSelf: 'center', marginTop: 10}}
              source={require('../../assets/images/makeup5.jpg')}
            />
          ...
          <Card
            ...
            <Card.Cover
              style={{width: '85%', alignSelf: 'center', marginTop: 10}}
              source={require('../../assets/images/makeup6.jpg')}
            />
        ...
        <View style={{flexDirection: 'row'}}>
          <Card
            ...
            <Card.Cover
              style={{width: '85%', alignSelf: 'center', marginTop: 10}}
              source={require('../../assets/images/makeup7.jpg')}
            />
          ...
          <Card
            ...
            <Card.Cover
              style={{width: '85%', alignSelf: 'center', marginTop: 10}}
              source={require('../../assets/images/makeup8.jpg')}
            />
